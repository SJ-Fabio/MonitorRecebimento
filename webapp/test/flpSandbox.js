		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Monitor",
									"targetURL": "#delawarepromonitor-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"delawarepromonitor-display": {
								"semanticObject": "delawarepromonitor",
								"action": "display",
								"description": "Monitor de Recebimento",
								"title": "Monitor",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=delaware.pro.monitor",
									"url": sap.ui.require.toUrl("delaware/pro/monitor")
								}
							}
						}
					}
